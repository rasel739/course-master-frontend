...
export default function CertificatesPage() {
    ...
    const handleDownloadPDF = async (certificate: Certificate) => {
        ...
        try {
            // Create a temporary container with pure inline styles (no Tailwind)
            ...
            tempContainer.innerHTML = `
                <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%;">
                    ...
                    <p style="font-size: 42px; font-weight: bold; color: #2563eb; margin: 0 0 24px 0;">${certificate.studentNameAtIssue}</p>
                    <p style="font-size: 18px; color: #4b5563; margin: 0 0 24px 0;">has successfully completed the course</p>
                    <p style="font-size: 28px; font-weight: 600; color: #111827; margin: 0 0 32px 0;">${certificate.courseTitleAtIssue}</p>
                    <p style="font-size: 16px; color: #6b7280; margin: 0;">Issued on ${formatDate(certificate.issuedAt)}</p>
                    <p style="font-size: 14px; color: #9ca3af; margin: 16px 0 0 0; font-family: monospace;">Certificate ID: ${certificate.certificateNumber}</p>
                </div>
            `;
                ...
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                    <Card className="w-full max-w-3xl max-h-[90vh] overflow-auto">
                        ...
                        <CardContent className="p-8">
                            ...
                            >
                                <Award style={{ width: '80px', height: '80px', color: '#2563eb', margin: '0 auto 16px' }} />
                                <h2 style={{ fontSize: '24px', fontWeight: 'bold', color: '#111827', marginBottom: '8px' }}>
                                    Certificate of Completion
                                </h2>
                                <p style={{ color: '#4b5563', marginBottom: '16px' }}>This is to certify that</p>
                                <p style={{ fontSize: '30px', fontWeight: 'bold', color: '#2563eb', marginBottom: '16px' }}>
                                    {selectedCertificate.studentNameAtIssue}
                                </p>
                                <p style={{ color: '#4b5563', marginBottom: '16px' }}>has successfully completed the course</p>
                                <p style={{ fontSize: '20px', fontWeight: '600', color: '#111827', marginBottom: '24px' }}>
                                    {selectedCertificate.courseTitleAtIssue}
                                </p>
                                <p style={{ fontSize: '14px', color: '#6b7280' }}>
                                    Issued on {formatDate(selectedCertificate.issuedAt)}
                                </p>
                                <p style={{ fontSize: '12px', color: '#9ca3af', marginTop: '8px', fontFamily: 'monospace' }}>
