...
const CourseDetails = () => {
  ...
  // Display data based on course - use real data when available
  const rating = course.averageRating || 4.5;
  const reviewCount = course.totalReviews || 0;
  const lastUpdated = new Date(course.updatedAt).toLocaleDateString('en-US', { month: 'long', year: 'numeric' });
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
            ...
            <div className='lg:col-span-2'>
              ...
              <div className='flex flex-wrap items-center gap-4 mb-4'>
                ...
                <span className='text-gray-300'>{course.totalEnrollments.toLocaleString()} students</span>
              </div>

              {/* Instructor & Update */}
              <div className='flex flex-wrap items-center gap-4 text-sm'>
                <span>
                  Created by <span className='text-blue-400 hover:underline cursor-pointer'>{course.instructor}</span>
                </span>
              ...
              <CardContent className='p-6'>
                ...
                <ul className='space-y-2'>
                  <li className='flex items-start space-x-2'>
                    ...
                    <span className='text-gray-700'>No programming experience needed - I&apos;ll teach you everything</span>
                  </li>
                  <li className='flex items-start space-x-2'>
                    <span className='text-gray-400'>•</span>
              ...
              <CardContent className='p-6'>
                ...
                <div className='prose prose-gray max-w-none'>
                  ...
                  <p className='text-gray-700'>
                    This comprehensive course will take you from a complete beginner to a confident developer.
            ...
            <div className='lg:sticky lg:top-6 space-y-4'>
              <Card className='overflow-hidden shadow-xl'>
                ...
                <CardContent className='p-6 space-y-4'>
                  ...
                  {/* CTA Buttons */}
                  {isEnrolled ? (
                    <Button className='w-full py-6 text-lg' onClick={() => router.push('/dashboard')}>
                      Go to Dashboard
                    </Button>
                  ) : (
                    <>
