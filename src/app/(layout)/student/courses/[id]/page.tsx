              ...
              <CardContent className='p-6'>
                ...
                <div className='prose prose-gray max-w-none'>
                  ...
                  <p className='text-gray-700'>
                    This comprehensive course will take you from a complete beginner to a confident
                    developer. You&apos;ll learn through hands-on projects and real-world examples
            ...
            <div className='lg:sticky lg:top-6 space-y-4'>
              <Card className='overflow-hidden shadow-xl'>
                ...
                <CardContent className='p-6 space-y-4'>
                  ...
                  {/* CTA Buttons */}
                  {isEnrolled ? (
                    <Button className='w-full py-6 text-lg' onClick={() => router.push('/student')}>
                      Go to Dashboard
                    </Button>
                  ) : (
                    <>
