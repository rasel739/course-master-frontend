...
export const metadata: Metadata = {
  ...
  description:
    'Learn about Course Master - Your trusted platform for online learning and skill development.',
};
          ...
          <div className='container mx-auto px-4'>
            <div className='max-w-4xl mx-auto text-center'>
              ...
              <p className='text-xl md:text-2xl text-blue-100 mb-8'>
                Course Master is your gateway to knowledge and skill development. We believe
              ...
              <div className='flex flex-wrap justify-center gap-4'>
                ...
                <Link href='/register'>
                  <Button
                    size='lg'
                    variant='outline'
                    className='border-white text-blue-600 hover:bg-white/20'
                  >
                    Join for Free
                  </Button>
                </Link>
            ...
            <div className='max-w-4xl mx-auto'>
              <div className='text-center mb-12'>
                ...
                <p className='text-xl text-gray-600'>
                  ...
                  experiences that empower individuals to achieve their goals and transform their
                  lives.
                </p>
              </div>
        ...
        <section className='py-20'>
          <div className='container mx-auto px-4'>
            <div className='max-w-3xl mx-auto text-center'>
              <div className='w-16 h-16 bg-linear-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-6'>
              ...
              <p className='text-xl text-gray-600 mb-8'>
                Join thousands of learners who are already transforming their careers with Course
                Master.
              </p>
              <div className='flex flex-wrap justify-center gap-4'>
                <Link href='/register'>
