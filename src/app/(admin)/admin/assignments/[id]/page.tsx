...
export default function AdminAssignmentDetailPage() {
    ...
    const courseTitle = typeof assignment.course === 'object' ? assignment.course.title : 'Unknown Course';
                    ...
                    {submissions.length === 0 ? (
                        ...
                        <div className="divide-y">
                            {submissions.map((submission: Submission) => {
                                const userName = typeof submission.user === 'object' ? submission.user.name : 'Unknown User';
                                        ...
                                        <div className="mt-3 ml-13 p-3 bg-gray-50 rounded-lg">
                                            <p className="text-sm text-gray-600">
                                                {submission.submissionType === 'link' ? (
                                                    <a href={submission.content} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                                                        {submission.content}
                                                    </a>
                                                ) : (
                                                    submission.content
